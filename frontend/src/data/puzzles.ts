import type { AvailableBlock, PuzzleDefinition } from '../types';
...
const movementBlocks: AvailableBlock[] = [
...
function puzzle(
  ...
  config: {
    ...
    station?: { x: number; y: number; treatment: 'medicine' | 'bandage' };
    obstacles: Array<{ x: number; y: number }>;
    symptoms: { itchy: boolean; sniffles: boolean; injured: boolean };
...
export function getPuzzleById(id: number): PuzzleDefinition | undefined {
